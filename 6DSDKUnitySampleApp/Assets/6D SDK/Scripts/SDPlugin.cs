...
namespace SixDegrees
{
    public class SDPlugin : MonoBehaviour
    {
        ...
        [DllImport("__Internal")]
        public static unsafe extern void SixDegreesSDK_Initialize(void* eaglContext = null);

        [DllImport("__Internal")]
        public static extern bool SixDegreesSDK_IsInitialized();

        [DllImport("__Internal")]
        public static extern int SixDegreesSDK_GetBackgroundTexture();
        ...
        [DllImport("__Internal")]
        public static extern bool SixDegreesSDK_HasRealTimeMesh();
        ...
        public static int SixDegreesSDK_GetBackgroundTexture() { return 0; }
        ...
        public static bool SixDegreesSDK_HasRealTimeMesh() { return false; }
