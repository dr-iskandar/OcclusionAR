...
/*!
 @brief Populates versionOut with the current version number of the SDK, e.g. "0.15.1"
...
/*!
 @brief Initializes ARKit and the SDK's internal states. Call this first!
 ...
 */
FOUNDATION_EXPORT void SixDegreesSDK_Initialize(void* eaglContext);
 ...
 */
FOUNDATION_EXPORT bool SixDegreesSDK_IsInitialized();
 ...
 */
FOUNDATION_EXPORT int SixDegreesSDK_GetBackgroundTexture();
 ...
 */
FOUNDATION_EXPORT void SixDegreesSDK_SaveToARCloud();

/*!
 @brief Interrupts and cancels the current SaveToARCloud process.
 */
FOUNDATION_EXPORT void SixDegreesSDK_CancelSave();
 ...
 */
FOUNDATION_EXPORT void SixDegreesSDK_LoadFromARCloud();

/*!
 @brief Interrupts and cancels the current LoadFromARCloud process.
 */
FOUNDATION_EXPORT void SixDegreesSDK_CancelLoad();
...
/*!
 @brief Returns whether the device updates the real world mesh locally.
 @discussion Depth estimation and real world mesh building are resource-intensive processes that are
 enabled on the most powerful devices only.
 @return true if the device has real time mesh updates, false otherwise.
 */
FOUNDATION_EXPORT bool SixDegreesSDK_HasRealTimeMesh();
 ...
 */
FOUNDATION_EXPORT float SixDegreesSDK_GetMeshBlockSize();
